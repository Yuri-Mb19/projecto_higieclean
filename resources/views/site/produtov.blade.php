...
<section class="product_section layout_padding">
    <div class="container">
      <div class="heading_container">
        ...
        <div class="box">
          <img src="images/produtos/1.png" width="278" height="240" alt="" />
        </div>
        <div class="box">
          <img src="images/produtos/2.png" width="278" height="240" alt="" />
        </div>
        <div class="box">
          <img src="images/produtos/3.png" width="278" height="240" alt="" />
        </div>
        <div class="box">
          <img src="images/produtos/4.png" width="278" height="240" alt="" />
        </div>
        <div class="box">
          <img src="images/produtos/5.png" width="278" height="240" alt="" />
        </div>
        <div class="box">
