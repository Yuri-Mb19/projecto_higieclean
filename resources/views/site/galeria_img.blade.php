...
<div class="container">
    <div class="header">
          ...
          <div style="text-align: center; color: #3f3f3f; padding: 40px 20px 25px; opacity: 0.9;"> 
              <h1><span id="logo"></span> Higeclean</h1>
              <h3>Nossa Galeria de Imagens<br/><br/>
	...
	<div class="content">
   		...
   		<a class="elem" href="{{asset('images/produtos/1.png')}}" title="image 1" data-lcl-txt="Aloi Vera" data-lcl-author="yuri" data-lcl-thumb="{{asset('images/produtos/1.png')}}">
        	<span style="background-image: url({{asset('images/produtos/1.png')}});"></span>
        </a>
        <a class="elem" href="{{asset('images/produtos/2.png') }}" title="image 2" data-lcl-txt="lorem ipsum dolor sit amet" data-lcl-author="yuri" data-lcl-thumb="{{asset('images/produtos/2.png') }}">
        	<span style="background-image: url({{asset('images/produtos/2.png') }});"></span>
        </a>
        ...
        <a class="elem" href="{{asset('images/produtos/5.png')}}" title="image 5" data-lcl-txt="lorem ipsum dolor sit amet" data-lcl-author="someone" data-lcl-thumb="{{asset('images/produtos/5.png')}}">
        	<span style="background-image: url({{asset('images/produtos/5.png')}});"></span>
        </a>
